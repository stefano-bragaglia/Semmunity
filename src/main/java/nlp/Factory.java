...
public class Factory {
	...
	public static SentenceDetector getSentenceDetector() {
		if (null == SENTENCE_DETECTOR) {
			...
			try {
				stream = Factory.class.getResourceAsStream("/en-sent.bin");
	...
	public static Tokenizer getTokenizer() {
		if (null == TOKENIZER) {
			InputStream stream = null;
			try {
				stream = Factory.class.getResourceAsStream("/en-token.bin");
	...
	public static POSTagger getPOSTagger() {
		if (null == POS_TAGGER) {
			InputStream stream = null;
			try {
				stream = Factory.class.getResourceAsStream("/en-pos-maxent.bin");
	...
	public static Chunker getChunker() {
		if (null == CHUNKER) {
			InputStream stream = null;
			try {
				stream = Factory.class.getResourceAsStream("/en-chunker.bin");
